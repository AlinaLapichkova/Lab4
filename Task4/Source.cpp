...
int main()
{
    ...
    SetConsoleCP(1251);
    double c = 0, n;
    cout << " Введите количество членов последовательности(n > 0) n = ";
    cin >> n;
    ...
    while (n <= 0 || n != int(n) || !firfirtest == cin.good())
    {
        cin.clear();
        cin.ignore(255, '\n');
        cout << "\n Введите количество членов последовательности (n > 0) n = ";
        cin >> n;
    }
    while (c == 0) {
        ...
        if (c == 1) {
            ...
            do {
                ...
                cin >> E;
                cout << " \n Введите x для нахождения частичной суммы ряда (x > 1) x = ";
                cin >> x;
                if (!test == cin.good() || x <= 1) {
                    system("cls");
                    cout << "\n\t Ошибка ввода (x > 1; n > 0)\n";
                    cin.clear();
                    cin.ignore(255, '\n');
